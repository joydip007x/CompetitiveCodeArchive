        ...
        LOOP(i,0,d)
            {  if (i==sax) continue;
                ...
                { if (j==sax) continue;
                    LOOP(k,i+2,d)
                    { if (k==sax) continue;
                if(arr[sax]==arr[i]+arr[j]+arr[k] )
                        {cout<<arr[sax]<<endl;flag=1;break;   }
                   ///   ppp=arr[i]+arr[j]+arr[j]; cout<<ppp<<"::>"<<endl;
//                        LOOP(ppp,0,d)
...
/*FUUUUUUUUUUUUUUKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK UUUUUUUUUUVVVVVVVVVVVAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA*/