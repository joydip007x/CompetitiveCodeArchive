...
/*optional solution *
http://shipuahamed.com/2013/11/lightoj-1054-efficient-pseudo-code.html
if 12= (2^2 )*3  then 12^5 is (2)^(2*5) and *3(^1*5) {this logic applies  cnt=(cnt * b)} and 
finding SOD , if 12=(2^2)*3 then you find it like (2 to the power 0 +2^1 + 2^2) means 
so means in GP(geometric progression ----https://www.mathsisfun.com/algebra/sequences-sums-geometric.html---- in the law of finding SOD r^n -1    , the n=2 er power after prime division+1 thats why              cnt=(cnt * b)+1<<<+1 korlm;
and again GP rule onujaiye sum of progression e r^n-1 /r-1 ;; so r-1 ke invmode korbo 
*/